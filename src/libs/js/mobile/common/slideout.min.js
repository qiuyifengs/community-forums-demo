!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{var f;"undefined"!=typeof window?f=window:"undefined"!=typeof global?f=global:"undefined"!=typeof self&&(f=self),f.Slideout=e()}}(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
    ...
    function Slideout(options) {
      ...
      // Sets  classnames
      if (!this.panel.classList.contains('gm-drawer-outpanel')) {
        this.panel.classList.add('gm-drawer-outpanel');
      }
      if (!this.panel.classList.contains('gm-drawer-outpanel-' + this._side)) {
        this.panel.classList.add('gm-drawer-outpanel-' + this._side);
      }
      if (!this.menu.classList.contains('gm-drawer ')) {
        this.menu.classList.add('gm-drawer');
      }
      if (!this.menu.classList.contains('gm-drawer-' + this._side)) {
        this.menu.classList.add('gm-drawer-' + this._side);
      }
    ...
    Slideout.prototype.open = function() {
      ...
      if (!html.classList.contains('gm-drawer-open')) {
        html.classList.add('gm-drawer-open');
      }
      this._setTransition();
    ...
    Slideout.prototype.close = function() {
      ...
      this._opened = false;
      setTimeout(function() {
        html.classList.remove('gm-drawer-open');
    ...
    Slideout.prototype._initTouchEvents = function() {
      ...
      this._onTouchMoveFn = function(eve) {
        ...
        if (Math.abs(dif_x) > 20) {
          ...
          if (!(self._moved && html.classList.contains('gm-drawer-open'))) {
            html.classList.add('gm-drawer-open');
          }
